...
const Layout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen relative">
      ...
      {/* Rest of your layout content with z-10 to appear above background */}
      <div className="relative z-10">
        ...
        {/* Footer */}
        <footer className="bg-black/80 backdrop-blur-sm mt-auto border-t border-green-700/30 relative z-10">
